...
namespace SimpleUi.Signals
{
	public static class SignalExtensions
	{
		...
		public static void OpenRootWindow(this SignalBus signalBus, EWindowLayer windowLayer = EWindowLayer.Local)
			=> signalBus.FireId(windowLayer, new SignalOpenRootWindow());
	}
